...
export default class CompanyPolicy extends Component {
  render() {
    return (
      <div
      ...
      >
        ...
        <i>
          ...
          <p>
            ...
            vehicles, trade secrets, computer software, hardware and networks,
          ...
          <p>
            ...
            receiving of gifts and promotional items of modest value is
            acceptable as is reasonable entertainment, if within the limits of
            responsible and generally accepted business practices.
          </p>
          <hr />
        </i>
      </div>
